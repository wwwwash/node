...
export default function PerformerLastTransactions(el, config) {
	PerformerLastTransactions.superclass.constructor.call(this, el, config);
}

Chaos.extend(PerformerLastTransactions, Page, {
	...
	init : function(el, config) {
        ...
        // Init futtatasa
		PerformerLastTransactions.superclass.init.call(this, el, config);
	},
     ...
     */
	bind : function() {
		PerformerLastTransactions.superclass.bind.call(this);
	},
     ...
     */
	unbind : function() {
		PerformerLastTransactions.superclass.unbind.call(this);
	}
});
